! function(e) {
    ...
    L.Control.Measure = L.Control.extend({
        ...
        _getMeasurementDisplayStrings: function(e) {
            ...
            function r(e, t, r, n) {
                var o = { acres: "Acres", feet: "PÃ©s", kilometers: "QuilÃ´metros", hectares: "Hectares", meters: "Metros", miles: "Milhas", sqfeet: "PÃ©sÂ²", sqmeters: "MetrosÂ²", sqmiles: "MilhasÂ²" },
...
}, function(e, t, r) { e.exports = '<a class="{{ model.className }}-toggle js-toggle" href=# title="Mede distÃ¢ncias e Ã¡reas">Medidas</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h6>Mede distÃ¢ncias e Ã¡reas</h6> <ul class=tasks> <a href=# class="js-start start">Criar nova medida</a> </ul> </div> <div class=js-measuringprompt> <h6>Mede distÃ¢ncias e Ã¡reas</h6> <p class=js-starthelp>Comece criando uma medida, adicionando pontos no mapa</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Cancelar</a></li> <li><a href=# class="js-finish finish">Finalizar medida</a></li> </ul> </div> </div> ' }, function(e, t, r) { e.exports = '<div class=group> <p class="lastpoint heading">Ãšltimo ponto</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>DistÃ¢ncia</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Ãrea</span> {{ model.areaDisplay }}</p> </div> <% } %> ' }, function(e, t, r) { e.exports = '<h6>LocalizaÃ§Ã£o do ponto</h6> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centralizar nesta localizaÃ§Ã£o</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Excluir</a></li> </ul> ' }, function(e, t, r) { e.exports = '<h6><span>Medida linear</span></h6> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centralizar nesta linha</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Excluir</a></li> </ul> ' }, function(e, t, r) { e.exports = '<h6><span>Medida de Ã¡rea</span></h6> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} PerÃ­metro</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centralizar nesta Ã¡rea</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Excluir</a></li> </ul> ' }]);